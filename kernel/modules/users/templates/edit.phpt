...
<?}?>
<form id="usersedit" name="usersedit" method="post" action="/admin/?mod=users&amp;act=edit&amp;id=<?=$args['id']?>" onsubmit="return (userscheckedit(this) && submitonce(this))">
<table width="450" border="0" cellspacing="2" cellpadding="4" class="table">
<tr>
  <th width="30%" align="right">Логин:</th>
  <td width="70%"><input type="text" value="<?=htmlspecialchars($args['login'])?>" style="width:100%" readonly="readonly" /></td>
</tr>
<tr>
