...
<?}?>
<form method="post" action="?mod=htdocs&amp;act=adddoc&amp;id=<?=$args['parent']['id']?>" onsubmit="return checkform(this) && submitonce(this)" enctype="multipart/form-data">
<fieldset>
<legend>
...
<table id="panelmain" width="100%" border="0" cellspacing="2" cellpadding="2" class="table" style="border:none">
  ...
  <tr>
    ...
    <td nowrap="nowrap">
      ...
      <td width="98%" class="none"><input type="text" class="none" name="path" id="path" style="width:100%" value="<?=trim($args['path'])?>" /></td>
      <td width="1%" class="none" style="padding-right:1px"><label for="path">.html</label></td>
      </tr></table>
    </td>
  </tr>
  <tr>
    <th align="right" class="<?=($errors['title']? 'error' : '')?>" nowrap="nowrap">* Название документа:</th>
  ...
  <tr>
    ...
    <td>
      <select name="id_maket">
        ...
        <option value="NULL"<?=($args['id_maket']===NULL? ' selected="selected"' : '')?>>наследовать (id:<?=$args['parent']['id_maket']?>)</option>
...
<?}?>
  ...
  <tr>
    ...
    <td>
     <textarea name="seo1" style="width:100%;height:100px"></textarea><br />
    </td>
  </tr>
  <tr>
    <th align="right" nowrap="nowrap">
    ...
    <td>
      <textarea name="seo2" style="width:100%;height:100px"></textarea><br />
    </td>
  </tr>
  
  <tr>
    <th width="20%" align="right" nowrap="nowrap">
      Краткий аннос:<br />
      <small>html</small>
    </th>
    <td>
