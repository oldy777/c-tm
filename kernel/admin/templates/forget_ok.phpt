...
<td align="center" valign="middle">
	...
	<tr><td class="main">
		...
		<tr>
		<td align="center">
		Новый пароль был успешно активирован!<br />
		Логин: <?=htmlspecialchars($args['login'])?><br />
		Пароль: <?=htmlspecialchars($args['passwd'])?><br />
		</td>
		</tr>
		<tr><td align="center"><input type="submit" value="Ok" class="button" /></td></tr>
		</table>
		</form>
	...
	<a href="/admin/login.php">Войти в систему</a> | <a href="/">На стартовую</a>
	</div>
