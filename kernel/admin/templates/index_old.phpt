...
<!-- head -->
<tr height="90" style="background:#FFFFFF url(/admin/images/head_bg1.gif) repeat-x top">
...
<td width="94%">
	...
	<div class="global"><a href="/admin/profile.php"><img src="/admin/images/icon_profile.gif" width="28" height="28" alt="Изменить профиль" ></a><br ><a href="/admin/profile.php">профиль</a></div>
	<div class="global"><a href="/"><img src="/admin/images/icon_start.gif" width="28" height="28" alt="Перейти на стартовую" ></a><br ><a href="/">стартовая</a></div>
	</td>
	</tr>
	</table>
</td>
...
<!-- middle -->
<tr>
<td style="background:white;"><img src="/admin/images/none.gif" width="5" height="1" alt="" ></td>
<td valign="top">
...
<?}else{?>
	<!-- splash -->
	<p>Вас приветствует система управления контентом &laquo;Slimpo&raquo; v<?=htmlspecialchars($args['version'])?>!</p>
